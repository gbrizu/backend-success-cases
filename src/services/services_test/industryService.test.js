...
describe('industryService', () => {
    ...
    describe('getAll', () => {
        ...
        jest.spyOn(IndustryModel, 'find').mockResolvedValue(mockIndustries);
        ...
        // Arrange
        jest.spyOn(IndustryModel, 'find').mockResolvedValue([]);
        ...
        // Arrange
        jest.spyOn(IndustryModel, 'find').mockRejectedValue(new Error('Database error'));
