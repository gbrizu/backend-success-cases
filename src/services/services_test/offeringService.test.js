...
describe('offeringService', () => {
    ...
    describe('getAll', () => {
        ...
        jest.spyOn(OfferingModel, 'find').mockResolvedValue(mockOfferings);
        ...
        // Arrange
        jest.spyOn(OfferingModel, 'find').mockResolvedValue([]);
        ...
        // Arrange
        jest.spyOn(OfferingModel, 'find').mockRejectedValue(new Error('Database error'));

        // Act & Assert
        await expect(offeringService.getAll()).rejects.toThrow('Database error');
        });
    });
});